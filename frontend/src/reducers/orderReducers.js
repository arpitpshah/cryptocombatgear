...
export const myOrderListReducer = (state={ order:[] },action) =>{
    switch(action.type){
        case MY_ORDER_LIST_REQUEST:
            return {
                loading:true
            }
        case MY_ORDER_LIST_REQUEST_SUCCESS:
            return {
                loading:false,
                orders: action.payload
            }
        case MY_ORDER_LIST_REQUEST_FAIL:
            return {
                loading:false,
                error: action.payload
            }
